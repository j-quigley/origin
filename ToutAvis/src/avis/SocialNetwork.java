...
public class SocialNetwork {
	...
	public LinkedList <String> consultItems(String nom) throws BadEntry {
		...
		//Test BadEntry
		if(nom==null) throw new BadEntry("Nom non instanci�");
	...
	/**
	 * Noter un avis post� pr�c�demment sur un item
	 * Ajoute une note � l�avis concern�. Le karma de son auteur en est impact�, comme la note globale de l�item
	 * Si une note de ce membre pr�-existe, elle sera modifi�e avec la nouvelle valeur
	 * 
	 * @param pseudo pseudo du membre Ã©mettant l'opinion
	 * @param password son mot de passe
	 * @param type type de l�item (livre ou film)
	 * @param titre titre de l�item  concernÃ©
	 * @param login pseudo de l�auteur de l�avis � noter
	 * @param note la note qu'il donne � l�avis
	 * 
	 * @throws BadEntry :
	 * <ul>
	 *  <li>  si le pseudo n'est pas instanciÃ© ou a moins de 1 caractÃ¨re autre que des espaces .  </li>
	 *  <li>  si le password n'est pas instanciÃ© ou a moins de 4 caractÃ¨res autres que des leadings or trailing blanks. </li>
	 *  <li>  si le titre n'est pas instanciÃ© ou a moins de 1 caractÃ¨re autre que des espaces.  </li>
	 *  <li>  si le type n'est pas instanciÃ© ou ne correspond pas � ��book�� ou ��film��  </li>
	 *  <li>  si la note n'est pas comprise entre 0.0 et 10.0. </li>
	 *  <li>  si le login n'est pas instanciÃ© ou a moins de 1 caractÃ¨re autre que des espaces .  </li>
	 * </ul><br>       
	 * @throws NotMember : si le pseudo n'est pas celui d'un membre ou si le pseudo et le password ne correspondent pas.
	 * @throws NotItem : si le titre n'est pas le titre d'un item du type recherch�.
	 * @throws NotReview : si le pseudo ne correspond � aucun auteur d�avis sur cet item.
	 * 
	...
	public float reviewOpinion(String pseudo, String password, String type, String titre, String login, float note)	throws BadEntry, NotItem, NotMember, NotReview {
		//Tests BadEntry
		if(Opinion.testBadEntry(pseudo, password, type, titre, login, note)) throw new BadEntry("Param�tres incorrects");
		//Tests NotMember
		Member m = null;
		for(Member membreTest : members ) {
			//on teste si le membre existe
		...
		//R�cup�ration du review concern�
